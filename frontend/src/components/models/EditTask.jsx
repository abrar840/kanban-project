                    ...
                    <Card className="border-none shadow-none">
                        <CardHeader className="pb-1">
                            ...
                            <div className="mt-2 w-[60%]">
                                <label htmlFor="assignee" className="text-sm font-medium text-gray-600 mb-1 block">
                                    Assigned to
                                </label>
                                <select
                                    id="assignee"
                                ...
                                >
                                    ...
                                    {task.user?.id && (
                                        <><option value={String(task.user.id)}>{task.user.full_name}</option>
                                        </>
                                    )}
                                    ...
                                    {contributors
                                        ...
                                        .map((contributor) => (
                                            <option key={contributor.id} value={String(contributor.id)}>
                                                {contributor.name}
                                            </option>
                                        ))}
                                </select>
